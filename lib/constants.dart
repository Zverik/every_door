...
const kAppVersion = '7.0-alpha2'; // Also used for presets.db versioning
...
const kEditMaxZoom = 22.0; // Same for all modes
...
const kMinBulkDownloadZoom = 12; // Min zoom for bulk downloading tiles
